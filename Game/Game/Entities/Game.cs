        ...
        public void Render(System.Drawing.Graphics g) {
            ...
            foreach (Baloon baloon in baloons.Baloons())
            {
                if (!baloon.GetIsDead())
                {
                    ...
                    //    currentPosition.X += stepSize;
                    //// tvelve line down 
                    //else if (currentPosition.X >= 490 && currentPosition.Y >= 280 && currentPosition.Y < 380)
                    //    currentPosition.Y += stepSize;
                    //// last line left
                    //else if (currentPosition.X >= 490 && currentPosition.X <= 650 && currentPosition.Y >= 380)
                    //    currentPosition.X += stepSize;
                    //baloon.Move(currentPosition);

                    //if (currentPosition.X >= 650 && currentPosition.Y >= 380)
                    //    baloon.SetDead();
                }
            }
